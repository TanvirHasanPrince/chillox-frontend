       ...
       <div className="hero-content flex-col lg:flex-row">
         ...
         <div className="mx-5">
           ...
           <p className="py-6">
             ...
             development of lean, heavy musculature into the production of beef,
             which does not depend on fat marbling (as a rule in other breeds of
             cattle) to achieve softness. Certified Piedomentes cattles are
             grown without using any strokes, growth hormones, or antibiotics,
             which ensures the highest quality and nutritious beef.
           </p>
