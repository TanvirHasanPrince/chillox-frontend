...
const Navbar = () => {
 const menuItems = 
 <React.Fragment >
  <li> <Link to = '/aboutus' className = 'hover:text-red-500 font-bold hover:border-2 hover:border-red-600 rounded' >About Us</Link> </li>
  <li> <Link to = '/menu' className = 'hover:text-red-500 font-bold hover:border-2 hover:border-red-600  rounded'>Menu</Link> </li>
  <li> <Link to = '/catering'className = 'hover:text-red-500 font-bold hover:border-2 hover:border-red-600 rounded'>Catering</Link> </li>
  <li> <Link to = '/contact'className = 'hover:text-red-500 font-bold hover:border-2 hover:border-red-600 rounded'>Contact</Link> </li>
 </React.Fragment>
 return (
   <div>
